...
disableRellaxOnMobile = {
  columnAA : document.querySelector('.container_artWall_columnA'),
  columnAB : document.querySelector('.container_artWall_columnB'),
  columnAC : document.querySelector('.container_artWall_columnC'),
